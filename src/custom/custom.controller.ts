...
export class TravelRouteController {
  ...
  async createTravelRoute(
    ...
    try {
      const travelRoute = await this.travelRouteService.createTravelRoute(
        req.user.id,
  ...
  async updateTravelRoute(
    ...
    try {
      ...
      const result = await this.travelRouteService.updateTravelRoute(
        travelrouteId,
        user.id,
        updateTravelRouteDto,
      );
  ...
  async updateDetailTravel(
    ...
    try {
      ...
      const result = await this.travelRouteService.updateDetailTravels(
        travelrouteId,
        updateRequest,
      );
      return res.status(HttpStatus.OK).json(result);
  ...
  async getTravelRoute(
    ...
    try {
      const result = await this.travelRouteService.getTravelRoute(
        userId,
        page,
        pageSize,
      );
  ...
  async addDetailToTravelRoute(
    ...
    try {
      ...
      const detailTravels =
        await this.travelRouteService.addDetailToTravelRoute(
          travelRouteId,
          updateDetailTravelDto,
        );
